...
class autotune_my_method():
    ...
    def circle_detection(self,param2):
        ...
        circles=cv2.HoughCircles(blurred,cv2.HOUGH_GRADIENT,dp=1.2,minDist=50,param1=100,param2=param2,minRadius=25,maxRadius=0)
        return circles
    ...
    def param_selection(self):
        ...
        # Fit circle to best contour
          R_max=min(self.img.shape[1],self.img.shape[0])//2
          ...
          if fr<0.1*R_max:
              ...
              color=(0,0,255)
          cv2.circle(refined, (fx, fy), fr, color,2)
          if color==(255,0,0):
              cv2.putText(refined,"small",(fx,fy-10),cv2.FONT_HERSHEY_PLAIN,1,(255,0,0),2)
          elif color==(0,255,0):
              cv2.putText(refined,"middle",(fx,fy-10),cv2.FONT_HERSHEY_PLAIN,1,(0,255,0),2)
          else:
              cv2.putText(refined,"Large",(fx,fy-10),cv2.FONT_HERSHEY_PLAIN,1,(0,0,255),2)
